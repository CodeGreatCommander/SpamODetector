...
export default function ContactFormWithSocialButtons() {
    ...
    const [contents,set_content]=useState("");
                            ...
                            <Box
                                ...
                                <VStack spacing={5}>
                                    ...
                                    <Button
                                        ...
                                        onClick={async() => {await fetch('http://localhost:3000/api/form',{method:"POST",body:JSON.stringify({"content":contents})}).then(x=>x.json()).then(x=>{console.log(x);set_response('Score is equal to '+x.response.Score+'\n and so the response is '+JSON.stringify(x.response.Details))});console.log(response)}}>
                                        Check Spamness
                                    </Button>
                                    <FormControl>
